...
public class LauncherSettings extends IScreen {
	...
	public LauncherSettings(final Pane root, final GameEngine engine, final LauncherPanel pane) {
		...
		this.titleLabel.setFont(FontLoader.loadFont("Cream Cake.ttf", "Cream Cake", 36f));
		...
		this.windowsSizeLabel.setFont(FontLoader.loadFont("Cream Cake.ttf", "Cream Cake", 36f));
		...
		this.sliderLabel.setFont(FontLoader.loadFont("Cream Cake.ttf", "Cream Cake", 36f));
		...
		this.saveButton.setFont(FontLoader.loadFont("Cream Cake.ttf", "Cream Cake", 36f));
